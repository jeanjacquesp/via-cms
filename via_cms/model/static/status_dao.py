...
class Status(Model, ValidateName):
    __tablename__ = 'status_tbl'
    ...
    def to_dict(self):
        ...
        # .format(self.id, self.name, self.label_ar, self.label_en)
        ...
        with open(file_path, encoding='utf-8') as csvfile:
            ...
            for row in reader:
                if first:
                    ...
                    status = Status(id=id, name=name, label_ar=label_ar, label_en=label_en,
